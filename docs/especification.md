...
-Agendamento flexivel para conciliar sua rotina​;
​
FRUSTAÇÕES:​
...
CENÁRIO DE USO:​ Carlos se cadastra na plataforma e expande sua area de atuação para o centro de Bh e região sul, onde ele sabe que existe uma densidade maior de pessoas. Depois de alguns dias e alguns contatos, ele agenda um visita para trocar todas as lâmpadas de um bar por nova e mais claras de led. Pagamento feito imediatamente atraves de pix. ​



PRESTADOR 02 - ENCANADOR
NOME:  Lucas Ferreira
IDADE: ​ 24 anos
PROFISSÃO: Encanador 
...
Cliente 03 - ELETRICISTA EMPREENDEDOR
NOME:  Roberto Nunes
IDADE: ​37 anos
PROFISSÃO: Eletricista 
